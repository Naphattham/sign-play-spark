    ...
    <div className="flex flex-col flex-1 min-h-[100dvh]">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16 flex-1 flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-20">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left space-y-5 sm:space-y-6">
          ...
          {/* Powered by */}
          <div className="lp-hero-text flex flex-col items-center md:items-start gap-1 md:gap-2 w-full" style={{ animationDelay: "0.5s" }}>

            {/* Line 1: Powered by Bangkok University */}
            <div className="flex flex-row items-center justify-center md:justify-start gap-1.5 md:gap-2 text-[10px] sm:text-xs text-foreground/50 font-bold">
              <span>Powered by</span>
              <div className="flex items-center gap-2">
                <img src="/ONLYBU_LOGO.webp" alt="BU Logo" className="h-4 sm:h-5 object-contain" />
                <a href="https://www.bu.ac.th/th/engineering/ai-engineering-datascience" target="_blank" rel="noopener noreferrer" className="hover:underline text-foreground/60 text-center md:text-left">
                  School of Engineering · Bangkok University
                </a>
              </div>
            </div>

            {/* Line 2: Associate with Suan Dusit University */}
            <div className="flex items-center gap-2 text-[10px] sm:text-xs text-foreground/50 font-bold">
              <span>Associate with</span>
              <div className="flex items-center justify-center gap-2">
                <img src="/SuanDusit_LOGO.webp" alt="Suan Dusit Logo" className="h-4 sm:h-5 object-contain" />
                <span className="text-foreground/60">Suan Dusit University</span>
              </div>
            </div>
          </div>
        </div>
