...
export default function SignAndMatchPage() {
  ...
  const startGame = useCallback(() => {
    ...
    // Prefetch first video instantly
  ...
  useEffect(() => {
    ...
    // Prefetch the NEXT video so it's ready (stand by) immediately
    const nextQ = currentQuestions[currentRoundIndex + 1];
    if (nextQ) {
      fetch(encodeURI(nextQ.videoUrl)).catch(() => { });
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        <main className="min-h-screen bg-[hsl(44,95%,96%)] dark:bg-slate-900 text-foreground relative p-4 md:p-8 flex flex-col items-center">
          ...
          <div className="max-w-6xl mx-auto flex flex-col items-center w-full">
            ...
            <div className="text-center mb-8 mt-12 md:mt-24">
              ...
              <p className="mt-4 font-bold text-base text-muted-foreground">ดูวิดีโอภาษามือแล้วเลือกคำศัพท์ภาษาไทยที่ถูกต้อง!</p>
            </div>
              ...
              <div className="neo-brutalism bg-white dark:bg-slate-800 rounded-xl p-6 w-full flex flex-col text-sm">
                ...
                <ul className="space-y-4 flex-grow flex flex-col justify-center font-bold text-base">
                  <li className="flex items-start">
                    ...
                    <p className="pt-1">ดูวิดีโอภาษามือจากโจทย์</p>
                  </li>
                  <li className="flex items-start">
                    ...
                    <p className="pt-1">เลือกตัวเลือกคำศัพท์ภาษาไทยที่ตรงกับวิดีโอ</p>
                  </li>
                  <li className="flex items-start">
