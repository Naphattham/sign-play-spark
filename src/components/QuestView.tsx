...
export function QuestView({ streak }: QuestViewProps) {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 lg:p-12 bg-background">
      {/* Header */}
      <header className="mb-12">
        <h2 className="text-4xl lg:text-6xl font-black uppercase italic tracking-tighter mb-2">
          Quest Log
        </h2>
        <p className="text-lg lg:text-xl font-bold text-slate-700 dark:text-slate-300">
      ...
      <section className="mb-16">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h3 className="text-2xl lg:text-3xl font-black uppercase">DAILY QUESTS</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div
            ...
            } border-[3px] border-foreground rounded-lg p-6 flex flex-col gap-4`}
            style={{ boxShadow: "4px 4px 0px 0px hsl(0 0% 0%)" }}
          >
            <div className="flex justify-between items-start">
              <div>
                <h4 className="text-xl lg:text-2xl font-black uppercase leading-tight">
            ...
            <div className="mt-4">
              ...
              <div className="w-full h-6 bg-slate-200 border-[3px] border-foreground rounded-sm overflow-hidden">
                <div
      ...
      <section>
        <div className="flex items-center gap-4 mb-6">
          ...
          <h3 className="text-2xl lg:text-3xl font-black uppercase">WEEKLY QUESTS</h3>
          <div className="h-1 flex-1 bg-black" />
        </div>

        <div className="space-y-6">
          {/* Weekly Quest Card 1 */}
          <div className="bg-white dark:bg-slate-800 border-[3px] border-foreground rounded-lg p-6 flex flex-col md:flex-row gap-6 items-center"
               style={{ boxShadow: "4px 4px 0px 0px hsl(0 0% 0%)" }}>
            <div className="w-24 h-24 shrink-0 bg-primary border-[3px] border-foreground rounded-lg flex items-center justify-center">
              <span className="material-symbols-outlined text-5xl text-white">timer</span>
            </div>
            <div className="flex-1 w-full">
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h4 className="text-xl lg:text-2xl font-black uppercase">
                    ฝึกซ้อม 30 นาที
                  </h4>
                  <p className="font-bold text-slate-600 dark:text-slate-400">
              ...
              <div className="flex items-center gap-4">
                <div className="flex-1 h-8 bg-slate-200 border-[3px] border-foreground rounded-sm overflow-hidden">
                  <div className="h-full bg-[#f94fa4] transition-all duration-500" style={{ width: "45%" }} />
                </div>
                <span className="font-black text-lg min-w-[80px] text-right">14/30m</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 border-[3px] border-foreground rounded-lg p-6 flex flex-col md:flex-row gap-6 items-center"
               style={{ boxShadow: "4px 4px 0px 0px hsl(0 0% 0%)" }}>
            <div className="w-24 h-24 shrink-0 bg-secondary border-[3px] border-foreground rounded-lg flex items-center justify-center">
            ...
            <div className="flex-1 w-full">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="font-black text-lg min-w-[80px] text-right">1/5</span>
              </div>
            </div>
          </div>
        </div>
