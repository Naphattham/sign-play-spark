...
export const VIDEO_URL_MAP: Record<string, string> = {
  // General — main clips
  "สวัสดี (ผู้ใหญ่)":      "/videos/general/hello_adult.webm",
  "สวัสดี (ผู้ใหญ่)main":  "/videos/general/hello_adult_main.webm",
  "สวัสดี (เพื่อน)":       "/videos/general/hello_friend.webm",
  "สวัสดี (เพื่อน)main":   "/videos/general/hello_friend_main.webm",
  "สบายดีไหม":             "/videos/general/how_are_you.webm",
  "สบายดี":                "/videos/general/fine.webm",
  "ไม่สบายใจ":             "/videos/general/unhappy.webm",
  "กินข้าวแล้วหรือยัง":   "/videos/general/Are_you_eaten.webm",
  "กินข้าวหรือยัง":        "/videos/general/Are_you_eaten.webm",
  "กินแล้ว":               "/videos/general/already_eat.webm",
  "ยังไม่ได้กิน":          "/videos/general/not_eat.webm",
  "ลาก่อน":                "/videos/general/goodbye.webm",
  // General — live step clips
  "กิน":                   "/videos/general/eat.webm",
  "แล้ว":                  "/videos/general/already.webm",
  "ยัง":                   "/videos/general/not_yet.webm",
  "ฉัน":                   "/videos/general/me.webm",
  "ไป":                    "/videos/general/go.webm",
  "ข้าว":                  "/videos/general/rice.webm",
  "หรือยัง":               "/videos/general/or_not_yet.webm",
  // Emotions
  "กลัว":                  "/videos/emotions/fear.webm",
  "รัก":                   "/videos/emotions/love.webm",
  "เหนื่อย":               "/videos/emotions/tired.webm",
  "โกรธ":                  "/videos/emotions/angry.webm",
  // Q&A
  "ทำไม":                  "/videos/qa/why.webm",
  "อะไร":                  "/videos/qa/what.webm",
  "เท่าไหร่":              "/videos/qa/how_much.webm",
  "ใช่":                   "/videos/qa/yes.webm",
  "ไม่":                   "/videos/qa/no.webm",
  // Illness
  "ปวดท้อง":               "/videos/illness/stomachache.webm",
  "ปวดหัว":                "/videos/illness/headache.webm",
  "เจ็บคอ":                "/videos/illness/sore_throat.webm",
  "เป็นหวัด":              "/videos/illness/cold.webm",
  "เป็นไข้":               "/videos/illness/fever.webm",
  // Tips
  "hello_adult-tip":       "/videos/Tips_video/hello_adult-tip.webm",
  "hello_friend-tip":      "/videos/Tips_video/hello_friend-tip.webm",
  "bye_me-tip":            "/videos/Tips_video/bye_me-tip.webm",
  "bye_go-tip":            "/videos/Tips_video/bye_go-tip.webm",
  "rice-tip":              "/videos/Tips_video/rice-tip.webm",
  "eat-tip":               "/videos/Tips_video/eat-tip.webm",
  "yet-tip":               "/videos/Tips_video/yet-tip.webm",
  "already-tip":           "/videos/Tips_video/already-tip.webm",
  "how_are_you-tip":       "/videos/Tips_video/how_are_you-tip.webm",
  "fine-tip":              "/videos/Tips_video/fine-tip.webm",
  "unhappy-tip":           "/videos/Tips_video/unhappy-tip.webm",
  "angry-tip":             "/videos/Tips_video/angry-tip.webm",
  "fear-tip":              "/videos/Tips_video/fear-tip.webm",
  "love-tip":              "/videos/Tips_video/love-tip.webm",
  "tired-tip":             "/videos/Tips_video/tired-tip.webm",
  "what-tip":              "/videos/Tips_video/what-tip.webm",
  "why-tip":               "/videos/Tips_video/why-tip.webm",
  "how_much-tip":          "/videos/Tips_video/how_much-tip.webm",
  "yes-tip":               "/videos/Tips_video/yes-tip.webm",
  "no-tip":                "/videos/Tips_video/no-tip.webm",
  "stomachache-tip":       "/videos/Tips_video/stomachache-tip.webm",
  "headache-tip":          "/videos/Tips_video/headache-tip.webm",
  "sore_throat-tip":       "/videos/Tips_video/sore_throat-tip.webm",
  "cold-tip":              "/videos/Tips_video/cold-tip.webm",
  "fever-tip":             "/videos/Tips_video/fever-tip.webm",
};

/**
 * Returns the direct /videos/*.webm path for a given display name or tip key.
...
export const getVideoUrl = (category: Category | string, fileName: string): string => {
  ...
  return `/videos/${category}/${fileName}.webm`;
};
